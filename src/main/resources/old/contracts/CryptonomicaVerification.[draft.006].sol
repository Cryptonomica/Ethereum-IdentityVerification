...
contract CryptonomicaVerification {
    ...
    function addressToAsciiString(address _address) private pure returns (string) {
    ...
    function requestStringToSignWithKey(string _fingerprint) public returns (string) {
        ...
        // bytes32
        bytes32 fingerprintBytes32 = stringToBytes32(_fingerprint);
        fingerprint[msg.sender] = fingerprintBytes32;
        bytes32FingerprintToAddress[fingerprintBytes32] = msg.sender;
        // string
    ...
    function getAddressConnectedToFingerprint(string memory _fingerprint) public view returns (address){
        bytes32 fingerprintBytes32 = stringToBytes32(_fingerprint);
        return bytes32FingerprintToAddress[fingerprintBytes32];
    }

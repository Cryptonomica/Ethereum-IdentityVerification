...
contract CryptonomicaVerification {
    ...
    // OpenPGP Message Format https://tools.ietf.org/html/rfc4880#section-12.2 :
    ...
    mapping (bytes32 => address) public addressByFingerprint; //
    ...
    function requestStringToSignWithKey(string _fingerprint) public returns (string) {
        ...
        addressByFingerprint[fingerprintBytes32] = msg.sender;
        // string
